<p align="center">
  <img src="https://img.shields.io/badge/version-8.5.0community-edition-50dca0?style=for-the-badge&labelColor=1a1a2e" />
  <img src="https://img.shields.io/badge/status-COMMUNITY%20EDITION-80dca0?style=for-the-badge&labelColor=1a1a2e" />
...
> **Release:** 2026-05-29 · **Author:** HyperSecurityLabs
...
[![Star on GitHub](https://img.shields.io/badge/%E2%AD%90%20Star%20to%20bring%20OXIDE%20to%20Kali-557C94?style=for-the-badge&labelColor=1a1a2e&logo=kali-linux)](https://github.com/hypersecuritylabs/OxideCE-v8.5.0community)
...
|----------|---------|------|--------|
| 🐧 **Debian** | `oxide-ce_8.5.0community-edition_amd64.deb` | 3.1M | `5a6bc1dea5aa240af3db70010418576e9411b37f0a177eeb54dee24f7ce10fe5` |
| 🐧 **Linux** | `oxide-ce-v8.5.0community-edition-linux.zip` | 4.2M | `6813a5e39675bf62ee6adf0dd3a319b1699243fc08a70ef217d92ce54447672d` |
| 🪟 **Windows** | `oxide-ce-v8.5.0community-edition-windows.zip` | 4.1M | `ca59291c86e366cbd0f6ae3bdf5906c9025cd89cb48e08db86e9f1c45c692c23` |
...
**Linux (portable):**
```bash
unzip oxide-ce-v8.5.0community-edition-linux.zip && cd oxide-v8.5.0community-edition-linux
...
const char* hs_version(void);   // "8.5.0community-edition"
```
...
**Proprietary** — Copyright © 2024-2026 HyperSecurityLabs · All Rights Reserved
...
> Removing HyperSecurityLabs brand or copyright = violation + legal action.
...
<p align="center">
  This is the <strong>Community Edition</strong> — countless hours of work.  
  If OXIDE helped you in a pentest, CTF, or research,  
  <a href="https://github.com/hypersecuritylabs/OxideCE-v8.5.0community"><strong>please star the repository ★</strong></a>
  <br/><br/>
  <a href="https://github.com/hypersecuritylabs/OxideCE-v8.5.0community">
    <img src="https://img.shields.io/badge/%E2%AD%90%20Star%20on%20GitHub-50dca0?style=for-the-badge&labelColor=1a1a2e" />
  </a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/COMMUNITY_EDITION-ff6450?style=for-the-badge&labelColor=1a1a2e" />
</p>
